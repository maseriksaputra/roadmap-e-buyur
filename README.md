...
<head>
  ...
  <style>
    ...
    *{margin:0;padding:0;box-sizing:border-box}
    ...
    .container{
      max-width:210mm;margin:0 auto;background:#fff;min-height:297mm;padding:20mm;
      box-shadow:0 0 20px rgba(0,0,0,.1)
    }

    .header{
      background:linear-gradient(135deg,#667eea 0%,#764ba2 100%);
      color:#fff;padding:30px;border-radius:10px;margin-bottom:30px;text-align:center
    }
    .header h1{font-size:32px;font-weight:700;margin-bottom:10px;letter-spacing:.3px}
    .header .subtitle{font-size:18px;opacity:.95}
    .header .date-range{
      font-size:16px;margin-top:12px;padding:8px 20px;background:rgba(255,255,255,.2);
      border-radius:20px;display:inline-block
    }

    .section{margin-bottom:35px}
    .section-title{
      font-size:24px;font-weight:600;color:#2d3748;margin-bottom:18px;padding-bottom:10px;
      border-bottom:3px solid #667eea;display:flex;align-items:center;gap:10px
    }
    .section-icon{
      width:30px;height:30px;border-radius:6px;background:#667eea;color:#fff;
      display:inline-flex;align-items:center;justify-content:center;font-size:18px
    }

    .dod-box{
      background:linear-gradient(135deg,#f6f9fc 0%,#e9f3ff 100%);
      border-left:4px solid #667eea;padding:18px;border-radius:8px;margin-bottom:20px
    }
    .dod-title{font-size:20px;font-weight:600;color:#2d3748;margin-bottom:10px}
    .dod-list{list-style:none}
    .dod-list li{
      padding:8px 0 8px 30px;position:relative;color:#4a5568
    }
    .dod-list li:before{
      content:"✓";position:absolute;left:0;color:#48bb78;font-weight:700;font-size:18px
    }
    ...
    .week{
      background:#fff;border:1px solid #e2e8f0;border-radius:10px;margin-bottom:22px;
      overflow:hidden;box-shadow:0 2px 4px rgba(0,0,0,.05)
    }
    .week-header{
      background:linear-gradient(90deg,#4a5568 0%,#2d3748 100%);color:#fff;
      padding:14px 18px;display:flex;justify-content:space-between;align-items:center
    }
    .week-title{font-size:18px;font-weight:600}
    .week-dates{
      background:rgba(255,255,255,.2);padding:5px 12px;border-radius:14px;font-size:13px
    }
    .week-content{padding:18px}
    .week-objective{
      background:#f7fafc;padding:12px;border-radius:6px;margin-bottom:14px;border-left:3px solid #667eea
    }
    .week-objective strong{color:#2d3748}

    .task-grid{display:grid;grid-template-columns:1fr 1fr;gap:16px;margin-top:8px}
    .task-column{background:#f9fafb;padding:14px;border-radius:8px;border:1px solid #edf2f7}
    .task-owner{font-weight:700;color:#2d3748;margin-bottom:8px;padding-bottom:8px;border-bottom:2px solid #e2e8f0}
    .task-list{list-style:none}
    .task-list li{
      padding:6px 0 6px 20px;position:relative;font-size:14px;color:#4a5568
    }
    .task-list li:before{content:"▸";position:absolute;left:0;color:#667eea}

    .ac-title{font-size:13px;color:#374151;margin:10px 0 4px;font-weight:600}
    .ac-list{list-style:none;margin-bottom:6px}
    .ac-list li{
      padding:4px 0 4px 22px;position:relative;font-size:13px;color:#475569
    }
    .ac-list li:before{
    ...
    .output-box{
      background:#f0fff4;border:1px solid #9ae6b4;padding:10px 12px;border-radius:6px;
      margin-top:12px;font-size:14px;color:#22543d
    }
    .output-box strong{color:#276749}
    ...
    .member-name{font-size:20px;font-weight:700;color:#2d3748;margin-bottom:6px}
    .member-role{color:#667eea;font-size:13px;margin-bottom:10px}
    .responsibility-list{list-style:none}
    .responsibility-list li{
      padding:8px 0 8px 24px;position:relative;font-size:14px;color:#4a5568;line-height:1.5
    }
    .responsibility-list li:before{
      content:"•";position:absolute;left:8px;color:#667eea;font-weight:700
    }

    .priority-list{background:#f7fafc;padding:16px;border-radius:8px;margin-top:10px}
    .priority-item{
      display:flex;align-items:center;gap:12px;padding:10px;background:#fff;border-radius:6px;border:1px solid #e2e8f0;margin-bottom:10px
    }
    .priority-number{
      width:30px;height:30px;background:#667eea;color:#fff;border-radius:999px;
      display:flex;align-items:center;justify-content:center;font-weight:700
    }
    .priority-text{flex:1;color:#2d3748}
    ...
    .risk-title{font-weight:700;color:#c53030;margin-bottom:6px}
    ...
    .footer{margin-top:26px;padding-top:16px;border-top:2px solid #e2e8f0;text-align:center;color:#718096;font-size:13px}

    .print-button{
      position:fixed;top:20px;right:20px;background:#667eea;color:#fff;padding:12px 18px;
      border:none;border-radius:6px;cursor:pointer;font-weight:700;
      box-shadow:0 4px 6px rgba(0,0,0,.1);z-index:1000
    }
    .print-button:hover{background:#5a67d8}
  </style>
</head>
...
<body>
      ...
      <div class="timeline">
          ...
          <div class="week-content">
            ...
            <div class="task-grid">
              <div class="task-column">
                ...
                <ul class="ac-list">
                  ...
                  <li>SPA/Flutter web bisa auth via Sanctum (CORS OK).</li>
                </ul>
              </div>
            ...
            <div class="task-grid" style="margin-top:14px">
              <div class="task-column">
                ...
                <ul class="task-list">
                  <li>Provision Hypercloud VM (Ubuntu LTS), user non-root, SSH key, UFW.</li>
                  <li>Install Nginx + PHP-FPM + MySQL/Postgres; Redis (opsional untuk cache/session).</li>
                  <li>CI/CD sederhana (GitHub Actions → deploy via SSH/rsync) + <code>.env.staging</code>.</li>
                </ul>
              </div>
              <div class="task-column">
                <div class="task-owner">👨‍💻 Devin — 3–4 Sep</div>
                <ul class="task-list">
                  <li>Cart per-user (limit 100, provider/riverpod/bloc).</li>
                  <li>Favorites per-user (limit 100).</li>
                  <li>Routing role: buyer vs seller dashboard setelah login.</li>
                </ul>
              </div>
            </div>
            ...
            <div class="task-grid" style="margin-top:14px">
              <div class="task-column">
                ...
                <ul class="task-list">
                  ...
                  <li>DB migrate & seed minimal (kategori, contoh produk).</li>
                  <li>Object storage S3-compatible (opsional).</li>
                </ul>
              </div>
              <div class="task-column">
                <div class="task-owner">👨‍💻 Devin — 5–6 Sep</div>
                <ul class="task-list">
                  <li>“Kelola Produk/Toko” ter-scope seller_id=auth (CRUD).</li>
                  <li>Pencarian: buyer global (nama/kategori), seller scoped.</li>
                </ul>
              </div>
            </div>
            ...
            <div class="task-grid" style="margin-top:14px">
              <div class="task-column" style="grid-column:1 / -1">
                ...
                <ul class="task-list">
                  <li>End-to-end (web + Android fisik): login → lihat produk → tambah cart/fav → checkout dummy.</li>
                  <li>Catat bug P0/P1 untuk backlog Minggu 2.</li>
                </ul>
              </div>
            </div>
          ...
          <div class="week-content">
            ...
            <div class="task-grid">
              <div class="task-column">
                ...
                <ul class="task-list">
                  <li>Endpoint admin: kalibrasi threshold (65–80%) → simpan di <em>settings</em> table atau env + cache.</li>
                  <li>API metadata model (nama file, versi/updated_at, threshold aktif).</li>
                </ul>
                <div class="ac-title">Acceptance</div>
                <ul class="ac-list">
                  <li>PATCH/PUT <code>/admin/settings/threshold</code> mengubah nilai aktif.</li>
                  <li>GET <code>/ml/model</code> mengembalikan label, versi, threshold.</li>
                </ul>
              </div>
              <div class="task-column">
                <div class="task-owner">👨‍💻 Devin — 8–10 Sep</div>
                <ul class="task-list">
                  <li>Integrasi TFLite FP16: muat <code>ebuyur_multitask_fp16.tflite</code>.</li>
                  <li>Head “type” (softmax) & “fresh” (sigmoid); tampilkan top-1 + probabilitas.</li>
                  <li>Badge “Layak” bila ≥ threshold aktif; fallback pesan (tips pencahayaan) jika model gagal.</li>
                </ul>
              </div>
            </div>
            ...
            <div class="task-grid" style="margin-top:14px">
              <div class="task-column">
                ...
                <ul class="task-list">
                  <li>Mode “Scan Beruntun”: kamera aktif, ambil N foto cepat.</li>
                  <li>Inferensi lokal tiap foto → draf list (gambar, label, % layak, catatan).</li>
                  <li>Tinjau draf → Post Massal → hit <code>create-product</code> / update stok/kelayakan.</li>
                  <li>Simpan draf lokal (Hive/SQLite) agar aman jika app ditutup.</li>
                </ul>
              </div>
              <div class="task-column">
                <div class="task-owner">👨‍💻 Erik — 11–12 Sep</div>
                <ul class="task-list">
                  <li>Endpoint <code>/batch/drafts</code> (opsional sync) & <code>/batch/commit</code> (validasi per item).</li>
                  <li>Policy ownership seller untuk setiap item (scope by <code>seller_id</code>).</li>
                </ul>
              </div>
            </div>
            ...
            <div class="task-grid" style="margin-top:14px">
              <div class="task-column" style="grid-column:1 / -1">
                ...
                <ul class="task-list">
                  <li>Android + LAN/4G: ukur latensi, memori, waktu inferensi.</li>
                  <li>Performa kamera: jika web kurang stabil, fokus Android untuk demo; web via HTTPS staging.</li>
                </ul>
              </div>
            </div>
          ...
          <div class="week-content">
            ...
            <div class="task-grid">
              <div class="task-column">
                ...
                <ul class="task-list">
                  <li>Cache katalog (TTL 24 jam) + penyimpanan lokal terbatas.</li>
                  <li>Local queue transaksi (pesanan/aksi batch) → retry saat online dengan indikator status.</li>
                  <li>UI indikator koneksi & status sinkronisasi.</li>
                </ul>
              </div>
              <div class="task-column">
                <div class="task-owner">👨‍💻 Erik — 15–16 Sep (Audit Trail)</div>
                <ul class="task-list">
                  <li>Tabel <code>product_audits</code> (product_id, seller_id, field, old→new, timestamp).</li>
                  <li>Middleware logging harga/stok; halaman admin untuk histori.</li>
                </ul>
              </div>
            </div>
            ...
            <div class="task-grid" style="margin-top:14px">
              <div class="task-column">
                ...
                <ul class="task-list">
                  <li>Migrasi produksi: clone dari staging, set env prod, DB prod, backup otomatis, log rotate.</li>
                  <li>Monitoring: Fail2ban, Prometheus/node exporter atau Netdata, alert email/Telegram.</li>
                </ul>
              </div>
              <div class="task-column">
                <div class="task-owner">👨‍💻 Devin — 18–19 Sep (UX/Perf)</div>
                <ul class="task-list">
                  <li>Poles UI/UX (empty/loading/error states, skeleton list, aksesibilitas dasar).</li>
                  <li>Performa list: pagination, debounced search.</li>
                </ul>
              </div>
            </div>
            ...
            <div class="task-grid" style="margin-top:14px">
              <div class="task-column" style="grid-column:1 / -1">
                ...
                <ul class="task-list">
                  <li>Buyer: browse → cart → checkout dummy.</li>
                  <li>Seller: kelola produk → batch scan → commit.</li>
                  <li>Bug list: kategorikan P0/P1/P2 untuk Minggu 4.</li>
                </ul>
              </div>
            </div>

            <div class="output-box"><strong>Output Minggu 3:</strong> offline ringan & audit trail aktif, lingkungan produksi siap, UAT-1 selesai.</div>
          </div>
        </div>
        ...
        <div class="week no-break">
          ...
          <div class="week-content">
            ...
            <div class="task-grid">
              <div class="task-column">
                <div class="task-owner">👨‍💻 Erik — 22–24 Sep (Keamanan & Kinerja)</div>
                <ul class="task-list">
                  <li>Rate limit endpoint; validasi input ketat; pagination default; index DB untuk kolom pencarian.</li>
                  <li>Backup otomatis + verifikasi pemulihan; SOP downtime singkat.</li>
                </ul>
              </div>
              <div class="task-column">
                <div class="task-owner">👨‍💻 Devin — 22–24 Sep (Polish Batch Scan)</div>
                <ul class="task-list">
                  <li>Seleksi massal, hapus dari draf, indikator progress saat commit.</li>
                  <li>UI slider threshold (read-only untuk non-admin); badge warna kelayakan konsisten.</li>
                </ul>
              </div>
            </div>
            ...
            <div class="task-grid" style="margin-top:14px">
              <div class="task-column">
                ...
                <ul class="task-list">
                  <li>Perf ringan (200–500 item, pencarian berulang).</li>
                  <li>Simulasi jaringan lemah (uji offline queue), kamera indoor/outdoor.</li>
                </ul>
              </div>
              <div class="task-column">
                <div class="task-owner">👨‍💻 Erik & Devin — 28–30 Sep</div>
                <ul class="task-list">
                  <li>Freeze kode (tag rilis <strong>v1.0</strong>), changelog, runbook deploy & recovery.</li>
                  <li>Materi presentasi: slide arsitektur (Laravel + Flutter + TFLite + Hypercloud), rekam demo buyer & seller, highlight ML & batch scan.</li>
                  <li>Buffer 29–30 Sep: perbaikan P0; rehearsal presentasi.</li>
                </ul>
              </div>
            </div>
  ...
  <div class="container page-break">
    ...
    <div class="section no-break">
      ...
      <div class="risk-grid">
        <div class="risk-item">
          ...
          <div>Webcam tidak berjalan tanpa HTTPS.</div>
        ...
        <div class="risk-item">
          ...
          <div>Packet loss/latensi memengaruhi UX.</div>
        ...
        <div class="risk-item">
          ...
          <div>Akses seller ke resource bukan miliknya.</div>
        ...
        <div class="risk-item">
          ...
          <div>Inferensi lambat/boros memori.</div>
        ...
        <div class="risk-item">
          ...
          <div>Login web gagal karena konfigurasi domain/stateful yang tidak konsisten.</div>
    ...
    <div class="section no-break">
      ...
      <div class="dod-box">
        ...
        <ul class="dod-list">
          <li><strong>Target “Siap”:</strong> 28–30 Sep code-freeze + materi presentasi → Awal Okt hanya uji & presentasi.</li>
          <li><strong>Prioritas:</strong> Batch Scan → Integrasi ML → Hosting stabil → Offline ringan → Audit trail.</li>
          <li><strong>Ritual:</strong> stand-up harian 15 menit; sync integrasi Selasa & Jumat; UAT Minggu 3 & 4.</li>
          <li><strong>Milestone:</strong> v1.0 dirilis 28 Sep (tag + changelog + runbook).</li>
        </ul>
      </div>
    </div>
  ...
  <script>
    // Set judul dokumen saat print agar nama file PDF rapi
